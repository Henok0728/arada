...
async def run_migrations_online() -> None:
    ...
    SQLAlchemy's async connection model. Creates the platform schema first
    so Alembic can write its version table there.
    """
    ...
    async with connectable.connect() as connection:
        # Ensure the schema exists before Alembic writes the version table.
